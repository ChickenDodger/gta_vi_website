    ...
    return (
        <section className="lucia-life">
            <div className="flex flex-col gap-5 items-end img-box lg:1/2 ps-10 mt-96">
                <div className="lucia-1">
                    <img src="/images/lucia-1.webp" alt="Lucia punching a punching bag." />
                </div>
                <div className="lucia-3">
                    <img src="/images/lucia-3.webp" alt="Lucia in a prison." />
                </div>
            </div>
        ...
        <div className=".lucia-life-content">
            ...
            <div className="lucia-2">
                <img src="/images/lucia-2.webp" alt="Lucia in a swimming pool." />
            </div>
